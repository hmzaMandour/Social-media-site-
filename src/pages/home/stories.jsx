    ...
    <>
      ...
      <div className="sekiro" style={{ display: 'flex', }}>
        {files.length > 0 ? (
          ...
          <div className="w-[120px] h-[180px] rounded-[25px] m-[10px] border border-solid flex justify-center pt-3 items-center">
            <img src="https://cdn.dribbble.com/users/22691/screenshots/1958250/attachments/340010/Button_800x600.gif" alt="Placeholder" />
          </div>
        )}
      </div>
        ...
        >
          ...
          >
            ...
            {currentMedia.type.startsWith('image/') ? (
              <img src={currentMedia.url} alt="Modal content" className="w-full h-auto object-contain" />
            ) : (
