...
export const Settings = () => {
  ...
  const [uploadedImg, setUploadedImg] = useState(obj.img ); 
            ...
            <div className='px-10 pb-10'>
              ...
              <div className='shadow-[0_3px_10px_rgb(0,0,0,0.2)] flex flex-col gap-5 rounded-2xl p-5 bg-white'>
                ...
                <div className='flex justify-between pb-4'>
                  <input type="text" placeholder='Your new username...' className='border border-solid rounded-md w-[30%] p-2 placeholder:text-[13px]' />
                  <input type="text" placeholder='Your new email...' className='border border-solid rounded-md w-[30%] p-2 placeholder:text-[13px]' />
                  <input type="text" placeholder='Your new password...' className='border border-solid rounded-md w-[30%] p-2 placeholder:text-[13px]' />
                  <button className="text-[#e040fb] text-lg font-bold rounded-full">
                    <MdDone />
                  </button>
                </div>
