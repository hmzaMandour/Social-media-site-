    ...
    <div className="h-[100vh] w-[100vw] bg-white flex justify-center items-center">
      <div className="h-[80vh] w-[90vw] bg-white boxshadoww rounded-[20px]">
        <div className="w-[100%] h-[45%] bg-[#ecc2f3] relative rd">
          ...
          >
            <div
              className="w-[200px] rounded-full h-[200px] bg-[#6e009e] absolute top-[150px] rd2 left-[150px]"
            >
              <input
                type="file"
                className="absolute top-0 left-0 opacity-0 w-full h-full cursor-pointer"
        ...
        <div onClick={() => { navigate("/home") }} className='flex justify-start items-end h-[50%] gap-[30px]'>
          ...
          <button onClick={() => { navigate("/home") }} className='h-[50px] w-[150px] bg-[#6e009e] rounded-[15px] flex justify-center items-center text-white gap-1'>
