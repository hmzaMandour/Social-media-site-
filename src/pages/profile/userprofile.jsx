            ...
            <div className='p-10'>
                ...
                <div className='shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-2xl p-5'>
                    <div className='userPic flex  items-center gap-5 border-b-[1px] border-gray-400 pb-10 pt-5 px-10'>
                        ...
                        <div>
                            <button className='border-solid border-[1px] border-gray-400 rounded-md py-2 px-5 font-semibold'>
                                Upload new photo
                            </button>

                            <p className='pt-3 text-gray-600 text-[14px]'>
                                At least 800 * 800 px recommended.
                            </p>

                            <p className='text-gray-600 text-[14px]'>
                                JPG or PNG in allowed
                            </p>
                        </div>
                    </div>
                                    ...
                                    <div className=' flex flex-col gap-4 pt-5'>
                                        <div>
                                            ...
                                            <input 
                                                type="text" 
                                                value="name" 
                                                className='bg-transparent font-semibold w-[100%]' 
                                            />
                                        </div>
                                        <div>
                                            <p>Email</p>
