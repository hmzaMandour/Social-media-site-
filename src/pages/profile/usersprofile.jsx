                            ...
                            <div>
                                ...
                                <div className=' flex gap-5 pb-3 '>
                                    <div className='flex flex-col  '>
                                        ...
                                        <p className='text-[13px] font-semibold '>{finding.followers} </p>
                                    </div>
                                    <div className='flex flex-col'>
                                        <p className=' text-gray-600 text-[13px]'>Following</p>
                                        <p className='text-[13px] font-semibold '>{finding.following} </p>
                                    </div>
                                </div>
                            ...
                            <div className=' flex flex-col gap-5 w-[30%]'>
                                <div className='bg-white rounded-md border-solid border-[1px] border-gray-400 p-3 w-[100%]'>
                                    ...
                                    <p className='flex items-center gap-2'>
                                        <GoLocation/>Lives in <span className='font-semibold'>{finding.location} </span>
                                    </p>
                                </div>
